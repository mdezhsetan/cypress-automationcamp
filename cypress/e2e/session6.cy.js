...
describe("Session 6", function () {
  ...
  it("3- Alerts - Prompt", function () {
    ...
    cy.get("#result").should(
      "have.text",
      "You entered: AutomationCamp-cypress"
    );
    cy.get("#result")
      .invoke("text")
      .should("equal", "You entered: AutomationCamp-cypress");
  });
  ...
  it("4- Dialog ", function () {
    ...
    cy.get('.docs-navbar-header > [href="/cdk"] > .mat-button-wrapper').then(
      function (cdk) {
        cy.get(
          "#dialog-data > .docs-example-viewer-wrapper > .docs-example-viewer-body >" +
            " .ng-star-inserted > .mat-focus-indicator > .mat-button-wrapper"
        ).click();
        cy.wait(1000);
  ...
  it("5-Snackbar (Toast Message) - By Text", function () {
    ...
    cy.get(
      "snack-bar-component-example.ng-star-inserted > .mat-focus-indicator"
    ).click();
  ...
  it("7- Tooltip message", function () {
    cy.visit(
      "https://material.angular.io/components/tooltip/examples#tooltip-message"
    );
    cy.get("#mat-input-2").clear().type("AutomationCamp Tooltip");
    cy.get(
      "tooltip-message-example.ng-star-inserted > .mat-focus-indicator"
    ).realHover();
